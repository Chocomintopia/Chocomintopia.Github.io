...
![33.png](../images/4/33.png)

这时候就是按照visual studio的提示装一些插件 重新回到UE打开Slash项目时 出现了这样的问题
![34.png](../images/4/34.png)点yes也无效 所以 建议在创建C++类之前先**备份** 这样随时就可以回到蓝图模式
